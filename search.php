...
$query="select count(*) from sk_content where title like '%{$_GET['keyword']}%'";
    ...
    <div id="main" class="auto">
        <div id="left">
            ...
            <ul class="postsList">
                <?php
                $query="select
			sk_content.title,sk_content.id,sk_content.time,sk_content.times,sk_content.member_id,sk_member.name,sk_member.photo
			from sk_content,sk_member where
			sk_content.title like '%{$_GET['keyword']}%' and
