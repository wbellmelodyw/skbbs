...
function vcode($width=120,$height=40,$fontSize=30,$countElement=5,$countPixel=100,$countLine=4){
    ...
    $img=imagecreatetruecolor($width, $height);//创建画板
    $colorBg=imagecolorallocate($img,rand(200,255),rand(200,255),rand(200,255));//给画板添加随机背景色
