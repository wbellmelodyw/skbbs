...
<div id="hot" class="auto">
    ...
    <ul class="newlist">
        <!-- 20条 -->
        <li><a href="#">[edg队]</a> <a href="#">S5juesai中...</a></li>

    </ul>
    <div style="clear:both;"></div>
</div>
<?php
$query="select * from sk_father_module order by sort desc";
        ...
        <div class="classList">
            ...
            if(mysqli_num_rows($result_son)){
                while ($data_son=mysqli_fetch_assoc($result_son)){
                    $query="select count(*) from sk_content where module_id={$data_son['id']} and time > CURDATE()";
                    $count_today=num($link,$query);
                    $query="select count(*) from sk_content where module_id={$data_son['id']}";
