...
$query="select * from sk_member where id={$_GET['id']}";
...
$query="select count(*) from sk_content where member_id={$_GET['id']}";
    ...
    <div id="main" class="auto">
        <div id="left">
            <ul class="postsList">
                ...
                $query="select
			sk_content.title,sk_content.id,sk_content.time,sk_content.member_id,sk_content.times,sk_member.name,sk_member.photo
			from sk_content,sk_member where
			sk_content.member_id={$_GET['id']} and
			sk_content.member_id=sk_member.id order by id desc {$page['limit']}";
                ...
                while($data_content=mysqli_fetch_assoc($result_content)){
                    ...
                    <li>
                        ...
                        <div class="subject">
                            ...
                            <p>
                                <?php
                                if(check_user($member_id,$data_content['member_id'],$is_manage_login)){//如果后台管理员登录或者帖子是前台用户所发
