...
$query="select count(*) from sk_content where module_id={$_GET['id']}";
$count_all=num($link,$query);
$query="select count(*) from sk_content where module_id={$_GET['id']} and time>CURDATE()";
$count_today=num($link,$query);

$query="select * from sk_member where id={$data_son['member_id']}";
    ...
    <div id="main" class="auto">
        <div id="left">
            ...
            <ul class="postsList">
                <?php
                $query="select
			sk_content.title,sk_content.member_id,sk_content.id,sk_content.time,sk_content.times,sk_member.name,sk_member.photo
			from sk_content,sk_member where
			sk_content.module_id={$_GET['id']} and
			sk_content.member_id=sk_member.id
			{$page['limit']}";
                ...
                while($data_content=mysqli_fetch_assoc($result_content)){
                    ...
                    <li>
                        ...
                        <div class="subject">
                            ...
                            <p>
                                楼主：<?php echo $data_content['name']?>&nbsp;<?php echo $data_content['time']?>&nbsp;&nbsp;&nbsp;&nbsp;最后回复：<?php echo $last_time?>	<br />					<?php
