...
$query="select * from sk_manage where id={$_SESSION['manage']['id']}";
$result_manage=execute($link, $query);
$data_manage=mysqli_fetch_assoc($result_manage);

$query="select count(*) from sk_father_module";
$count_father_module=num($link,$query);

$query="select count(*) from sk_son_module";
$count_son_module=num($link,$query);

$query="select count(*) from sk_content";
$count_content=num($link,$query);

$query="select count(*) from sk_reply";
$count_reply=num($link,$query);

$query="select count(*) from sk_member";
$count_member=num($link,$query);

$query="select count(*) from sk_manage";
    ...
    <div id="main">
        ...
        <div class="explain">
            <ul>
                ...
                <li>|- 最大上传文件：<?php echo ini_get('upload_max_filesize')?></li>//php.ini
