...
<meta name="description" content="后台界面" />
    ...
    foreach ($template['css'] as $val){
        echo "<link rel='stylesheet' type='text/css' href='{$val}' />"; //将引用header.inc的页面所要引用的CSS以数组形式传到这里
    }
    ?>
</head>
<body>
	...
	<ul>
		<li>
			...
			<ul class="child">
				...
				<li><a <?php if(basename($_SERVER['SCRIPT_NAME'])=='web_setting.php'){echo 'class="current"';} ?> href="web_setting.php">站点设置</a></li>
			</ul>
		</li>
		<li><!--  class="current" -->
